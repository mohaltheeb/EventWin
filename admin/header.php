				...
				<ul class="nav user-menu">
					...
					<li class="nav-item dropdown app-dropdown">
						<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
							<span class="user-img"><img class="rounded-circle" src="assets/img/profiles/avatar-01.png" width="31" alt="Mohammed"></span>
						</a>
						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li><a href="userorganizer.php"> Organizer </a></li>
								</ul>
							</li>
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-user"></i> <span> Event</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
