            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Organizer</h3>
								<ul class="breadcrumb">
								...
								<div class="card-body">
									...
									<table id="basic-datatable" class="table">
											...
											<?php
												...
												$query=mysqli_query($con,"select * from user where utype='organizer'");
												$cnt=1;
											...
											?>
                                                <tr>
                                                    ...
                                                    <td><a href="userorganizerdelete.php?id=<?php echo $row['0']; ?>">Delete</a></td>
                                                </tr>
                                                <?php
												$cnt=$cnt+1;
												} 
