					...
					<div class="col-lg-8">
                        <div class="row">
							...
							if(isset($_REQUEST['filter']))
							{
								...
								$sql="SELECT * FROM event WHERE type='{$type}' and stype='{$stype}' and city='{$city}'";
                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    ...
                                    <div class="featured-thumb-data shadow-one">
                                        <div class="p-4">
                                            <h5 class="text-secondary hover-text-primary mb-2 text-capitalize"><a href="eventdetail.php?pid=<?php echo $row['0'];?>"><?php echo $row['1'];?></a></h5>
                            ...
                            <?php 		
									...
									echo "<h1 class='mb-5'><center>No Events Available</center></h1>";
								}
