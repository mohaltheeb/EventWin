    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Event</b></h2>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
					...
					<div class="col-lg-8">
                        <div class="row">
							...
							<?php 
								...
								$state=$_REQUEST['id'];
								$query=mysqli_query($con,"SELECT event.*, user.uname,user.utype,user.uimage FROM `Event`,`user` WHERE Event.uid=user.uid and state='$state'");
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="sidebar-widget mt-5">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4">Recent Event Add</h4>
