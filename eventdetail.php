    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Event Detail</b></h2>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
					...
					<?php
						$id=$_REQUEST['eid']; 
						$query=mysqli_query($con,"SELECT event.*, user.* FROM `event`,`user` WHERE event.uid=user.uid and eid='$id'");
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div id="single-property" style="width:1200px; height:700px; margin:30px auto 50px;"> 
                                    <!-- Slide 1-->
                                    <div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;"> <img width="1920" height="1080" src="admin/event/<?php echo $row['16'];?>" class="ls-bg" alt="" /> </div>
                                    
                                    <!-- Slide 2-->
                                    <div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;"> <img width="1920" height="1080" src="admin/event/<?php echo $row['17'];?>" class="ls-bg" alt="" /> </div>
                                    
                                    <!-- Slide 3-->
                                    <div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;"> <img width="1920" height="1080" src="admin/event/<?php echo $row['18'];?>" class="ls-bg" alt="" /> </div>
									
									<!-- Slide 4-->
									<div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;"> <img width="1920" height="1080" src="admin/event/<?php echo $row['19'];?>" class="ls-bg" alt="" /> </div>
									
									<!-- Slide 5-->
									<div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;"> <img width="1920" height="1080" src="admin/event/<?php echo $row['20'];?>" class="ls-bg" alt="" /> </div>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <span class="mb-sm-20 d-block text-capitalize"><i class="fas fa-map-marker-alt text-primary font-12"></i> &nbsp;<?php echo $row['12']?> </span>
							</div>
                            <div class="col-md-6">
                                <div class="text-primary text-left h5 my-2 text-md-right">$<?php echo $row['11'];?></div>
                        ...
                        <div class="property-details">
                            <div class="bg-gray property-quantity px-4 pt-4 w-100">
                                <ul>
                                    ...
                                    <li><span><?php echo $row['5'];?></span> VIP Seats</li>
                                    <li><span><?php echo $row['6'];?></span> Event Start</li>
                            ...
                            <h5 class="mt-5 mb-4 text-secondary">Event Summary</h5>
                            ...
                            <h5 class="mt-5 mb-4 text-secondary double-down-line-left position-relative">Contact Organizer</h5>
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar-widget mt-5">
                            ...
                            <ul class="property_list_widget">
								...
								<?php 
								$query=mysqli_query($con,"SELECT * FROM `event` ORDER BY date DESC LIMIT 9");
										while($row=mysqli_fetch_array($query))
										{
								?>
